...
function search_order_history(fixedSearchPeriod){
    ...
    i_fixedSearch_period.value=fixedSearchPeriod;
     ...
     formObj.method="get";
     formObj.action="${contextPath}/adminGoods/flightListGoodsHistory.do";
     formObj.submit();
}
</script>
<style>
...
<div class = "container ms-2 text-center">
   ...
   <nav class="text-end" style="margin-top:0.5%; text-align:center;" aria-label="breadcrumb">
      <ol class="breadcrumb">
         <li class="breadcrumb-item"><a href="${contextPath}/adminGoods/flightListGoodsHistory.do" style="text-decoration:none; color:black;">상품 관리</a></li>
      ...
      <table class="table table-hover text-center col-md-12 justify-content-center">
         ...
         <c:if test="${not empty myOrderHistList}">
            ...
            <c:if test="${item1.goods_status == 1 and item1.goods_category == '항공'}">
